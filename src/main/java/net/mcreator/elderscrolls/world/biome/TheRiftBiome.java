...
public class TheRiftBiome extends ElderscrollsModElements.ModElement {
	public static Biome biome;
	public TheRiftBiome(ElderscrollsModElements instance) {
		super(instance, 16);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-14211158).setWaterFogColor(-14217870)
						.withSkyColor(7972607).withFoliageColor(-3355648).withGrassColor(-3355648).build();
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.BIRCH_LOG.getDefaultState()),
								...
								new StraightTrunkPlacer(8, 2, 0), new TwoLayerFeature(1, 0, 1))).setIgnoreVines().setMaxWaterDepth(0).build())
				...
				event.getRegistry().register(biome.setRegistryName("elderscrolls:the_rift"));
			}
		}
	}
	@Override
